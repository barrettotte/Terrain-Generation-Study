...
public class MapGenEditor : Editor {
    ...
    public override void OnInspectorGUI(){
		...
		if (MapGenerator.mapWidth < 1) MapGenerator.mapWidth = 1;
        if (MapGenerator.mapHeight < 1) MapGenerator.mapHeight = 1;
        #endregion
